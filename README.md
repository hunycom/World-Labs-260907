> **Notice**: Looking for the **Spark Spatial Intelligence OS** project documentation? See [PROJECT_README.md](PROJECT_README.md).
> This repository is a specialized application platform built on top of the open-source Spark.js rendering engine.
