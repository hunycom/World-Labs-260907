#!/usr/bin/env python3
"""
scripts/generate_holdout_clicks.py

EXE-260906-P3-02-T5 Task 1: Deterministic Holdout Picking Dataset Generator
...
Saves output to tests/p3/t5_holdout_clicks.json and records SHA256 in docs/p3/raw/t5_holdout_clicks_sha256.txt.
Once generated, tests/p3/t5_holdout_clicks.json is strictly frozen and never modified.
"""
...
OUT_JSON = TESTS_DIR / "t5_holdout_clicks.json"
RAW_SHA_FILE = RAW_DIR / "t5_holdout_clicks_sha256.txt"
...
def main():
    ...
    raw_sha_content = f"{file_sha256}  tests/p3/t5_holdout_clicks.json\n"
    RAW_SHA_FILE.write_text(raw_sha_content, encoding="utf-8")

    print("==================================================================")
    print("  EXE-260906-P3-02-T5 Task 1: Holdout Clicks Dataset Generated")
    print("==================================================================")
